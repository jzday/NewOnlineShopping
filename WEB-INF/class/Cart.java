...
/* displayCart Function shows the products that users has bought, these products will be displayed with Total Amount.*/
	...
	protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(utility.CartCount()>0)
		{
			...
			/*This is cancel order function*/
			pw.print("<form name ='Cart'>");
			pw.print("<tr><td></td><td></td><td><input type='submit' name='CancelOrder' value='CancelOrder' class='btnbuy' /></td>");
			if(request.getParameter("CancelOrder")!=null && request.getParameter("CancelOrder").equals("CancelOrder"))
			{
				utility.removeItem();
