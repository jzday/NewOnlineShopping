...
public class DealMatchesUtilities extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            pw.print("<img src='img/smartportable.jpeg' style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
            pw.print("<br> <br>");
            ...
            for (Map.Entry<String, Product> entry : productmap.entrySet()) {
                ...
                if (selectedproducts.size() < 2 && !selectedproducts.containsKey(entry.getKey())) {
                    ...
                    BufferedReader reader = new BufferedReader(new FileReader(new File(  "/Users/jinzhedai/Downloads/HW1_Dai,Jinzhe/onlineShopping-master/web/DealMatchesDJZ1.txt")));
        ...
        if (selectedproducts.size() == 0) {
            ...
            for (Map.Entry<String, Product> entry : selectedproducts.entrySet()) {
                ...
                pw.print("<li id='item'><img src='images/watch_folder" +  "/" + entry.getValue().getImage() + "' alt='' />");
                pw.print("</li><li>");
