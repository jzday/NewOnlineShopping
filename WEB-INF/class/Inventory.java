...
//        utility.printHtml("LeftNavigationBar.html");
        ...
        pw.print("Product Inventory");
        pw.print("</h3>");
        pw.print("<div class='entry'>");

        pw.print("<table class='gridtable'>");
        pw.print("<tr>");
        pw.print("<td>Product_Name</td>");
        pw.print("<td>Price</td>");
        pw.print("<td>product available</td>");
        pw.print("</tr>");
        ...
        pw.println(" </script>");
                ...
                pw.print("<div class='post'>");
                pw.print("<h3 class='title'>");
                pw.print("Bar Chart of Product Inventory");
                pw.print("</h3>");
                pw.print("<div class='entry'>");
        ...
        pw.print("<div class='post'>");
        pw.print("<h3 class='title'>");
        pw.print("All products currently on sale");
        pw.print("</h3>");
        pw.print("<div class='entry'>");
        ...
        pw.print("<div class='post'>");
        pw.print("<h3 class='title'>");
        pw.print("All Products currently that have manufacturer rebates");
        pw.print("</h3>");
        pw.print("<div class='entry'>");
