...
public class SalesManOrder extends HttpServlet {
    HttpSession session;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("Order") != null && request.getParameter("Order").equals("Cancel")) {
           ...
           // utility.printHtml("LeftNavigationBar.html");
            ...
            pw.print("<input type='hidden' name='customerName' value='" + productName + "'>");
            pw.print("<input type='hidden' name='productName' value='" + username + "'>");
