...
//					Accessory accessory= SaxParserDataStore.accessories.get(acc.getValue());
					if (k==0 )
					{
						...
						sb.append("<div class='item active'><div class='col-md-5' style = 'background-color: #58acfa;border :1px solid #cfd1d3'>");
					}
					else
					{
						sb.append("<div class='item'><div class='col-md-5' style = 'background-color: #58acfa ;border :1px solid #cfd1d3' >");
					}

					sb.append("<div id='shop_item'>");
					sb.append("<h3>"+prodObj.getName()+"</h3>");
					sb.append("<strong>"+prodObj.getPrice()+"$</strong><ul>");
					sb.append("<li id='item'><img src='images/watch_folder/" + prodObj.getImage() +"' alt='' /></li>");
